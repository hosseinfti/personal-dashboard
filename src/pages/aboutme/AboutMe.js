    ...
    return (
      <div className="right-side about-me-container">
        ...
        <p className="about-me-p">
          ...
          <p>
            بسیار علاقه مند به کامپیوتر هستم <br />
            ولی از ۲۰ سالگی مشغول کار حسابداری شدم. تقریبا ۱۰ سال پیش قرار بود برای
          ...
          <p>
            ...
            <p>
              <p>
                طی این چهار ماه از HTML و CSS شروع کردم و همینطور در ادامه
                مفاهیم اصلی javaScript رو خوندم و بعد از اون React رو شروع کردم.<br />
                برای مطلعه هرکدوم هم تماما از منابع زبان اصلی مربوط به خودشون استفاده کردم. <br />
